...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p class="rating-info"> <span>Rating: <i class="fas fa-star"></i> ${product.rating?.rate}</span>  <span>count: <i class="fas fa-users"></i> ${product.rating?.count}</span></p>
      <button onclick="addToCart(${product.price})" id="addToCart-btn" class="buy-now btn btn-success"><i class="fas fa-shopping-cart"></i> add to cart</button>
      <button id="details-btn" class="btn btn-warning">Details <i class="fas fa-info-circle"></i></button></div>
      `;
